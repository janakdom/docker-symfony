...
CREATE USER 'pma'@'%' IDENTIFIED BY 'passwd123';
...
('symfony', '2021-11-27 16:04:27', '{\"Console\\/Mode\":\"collapse\",\"FirstDayOfCalendar\":1,\"Server\\/hide_db\":\"information_schema\",\"2fa\":{\"type\":\"db\",\"backend\":\"\",\"settings\":[]}}');
